...
public b4a.example.zapatos _zapatos = null;
...
RDebugUtils.currentLine=131074;
 //BA.debugLineNum = 131074;BA.debugLine="zapatos.Initialize(\"tienda.data\")";
mostCurrent._zapatos._initialize /*String*/ (null,processBA,"tienda.data");
...
RDebugUtils.currentLine=393216;
 //BA.debugLineNum = 393216;BA.debugLine="Private Sub BtnActualizar_Click";
RDebugUtils.currentLine=393217;
 //BA.debugLineNum = 393217;BA.debugLine="zapatos.Update(txtId.Text, txtNombreProducto.Text";
mostCurrent._zapatos._update /*boolean*/ (null,(int)(Double.parseDouble(mostCurrent._txtid.getText())),mostCurrent._txtnombreproducto.getText(),(double)(Double.parseDouble(mostCurrent._txtpreciounitario.getText())),(double)(Double.parseDouble(mostCurrent._txtiva.getText())),(double)(Double.parseDouble(mostCurrent._txtstock.getText())));
RDebugUtils.currentLine=393218;
 //BA.debugLineNum = 393218;BA.debugLine="Msgbox(\"registro actualizado!!\",\"Ok\")";
...
RDebugUtils.currentLine=327680;
 //BA.debugLineNum = 327680;BA.debugLine="Private Sub cmdDelete_Click";
RDebugUtils.currentLine=327681;
 //BA.debugLineNum = 327681;BA.debugLine="zapatos.Delete(txtId.Text)";
mostCurrent._zapatos._delete /*boolean*/ (null,(int)(Double.parseDouble(mostCurrent._txtid.getText())));
RDebugUtils.currentLine=327682;
 //BA.debugLineNum = 327682;BA.debugLine="txtId.Text = \"\"";
mostCurrent._txtid.setText(BA.ObjectToCharSequence(""));
RDebugUtils.currentLine=327683;
 //BA.debugLineNum = 327683;BA.debugLine="txtNombreProducto.Text= \"\"";
mostCurrent._txtnombreproducto.setText(BA.ObjectToCharSequence(""));
RDebugUtils.currentLine=327684;
 //BA.debugLineNum = 327684;BA.debugLine="txtprecioUnitario.Text= \"\"";
mostCurrent._txtpreciounitario.setText(BA.ObjectToCharSequence(""));
RDebugUtils.currentLine=327685;
 //BA.debugLineNum = 327685;BA.debugLine="txtIva.Text = \"\"";
mostCurrent._txtiva.setText(BA.ObjectToCharSequence(""));
RDebugUtils.currentLine=327686;
 //BA.debugLineNum = 327686;BA.debugLine="txtStock.Text= \"\"";
mostCurrent._txtstock.setText(BA.ObjectToCharSequence(""));
RDebugUtils.currentLine=327687;
 //BA.debugLineNum = 327687;BA.debugLine="Msgbox(\"Registro borrado !!\", \"OK\")";
...
RDebugUtils.currentLine=1376256;
 //BA.debugLineNum = 1376256;BA.debugLine="Private Sub cmdInsert_Click";
RDebugUtils.currentLine=1376257;
 //BA.debugLineNum = 1376257;BA.debugLine="zapatos.Create(txtId.Text, txtNombreProducto.Text";
mostCurrent._zapatos._create /*b4a.example.zapato*/ (null,(int)(Double.parseDouble(mostCurrent._txtid.getText())),mostCurrent._txtnombreproducto.getText(),(double)(Double.parseDouble(mostCurrent._txtpreciounitario.getText())),(double)(Double.parseDouble(mostCurrent._txtiva.getText())),(double)(Double.parseDouble(mostCurrent._txtstock.getText())));
RDebugUtils.currentLine=1376258;
 //BA.debugLineNum = 1376258;BA.debugLine="Msgbox(\"registro insertado !!\", \"Ok\")";
...
RDebugUtils.currentLine=458752;
 //BA.debugLineNum = 458752;BA.debugLine="Private Sub cmdReadById_Click";
RDebugUtils.currentLine=458753;
 //BA.debugLineNum = 458753;BA.debugLine="Dim p As Zapato= zapatos.Read_ById(txtId.Text)";
_p = mostCurrent._zapatos._read_byid /*b4a.example.zapato*/ (null,(int)(Double.parseDouble(mostCurrent._txtid.getText())));
RDebugUtils.currentLine=458754;
 //BA.debugLineNum = 458754;BA.debugLine="If p.IsInitialized Then";
if (_p.IsInitialized /*boolean*/ ()) { 
RDebugUtils.currentLine=458755;
 //BA.debugLineNum = 458755;BA.debugLine="txtId.Text = p.Id";
mostCurrent._txtid.setText(BA.ObjectToCharSequence(_p._id /*int*/ ));
RDebugUtils.currentLine=458756;
 //BA.debugLineNum = 458756;BA.debugLine="txtNombreProducto.Text= p.NombreProducto";
mostCurrent._txtnombreproducto.setText(BA.ObjectToCharSequence(_p._nombreproducto /*String*/ ));
RDebugUtils.currentLine=458757;
 //BA.debugLineNum = 458757;BA.debugLine="txtprecioUnitario.Text= p.PrecioUnitario";
mostCurrent._txtpreciounitario.setText(BA.ObjectToCharSequence(_p._preciounitario /*double*/ ));
RDebugUtils.currentLine=458758;
 //BA.debugLineNum = 458758;BA.debugLine="txtIva.Text = p.IVA";
mostCurrent._txtiva.setText(BA.ObjectToCharSequence(_p._iva /*double*/ ));
RDebugUtils.currentLine=458759;
 //BA.debugLineNum = 458759;BA.debugLine="txtStock.Text= p.stock";
mostCurrent._txtstock.setText(BA.ObjectToCharSequence(_p._stock /*double*/ ));
 }else {
RDebugUtils.currentLine=458761;
 //BA.debugLineNum = 458761;BA.debugLine="Msgbox(\"producto no encontrado\", \"Error\")";
